  ...
  const supervisorSections = [
    {
      ...
      color: 'blue',
      actions: [
        { name: 'Monitorear Visitas', icon: EyeIcon, action: () => console.log('Monitorear visitas'), color: 'blue' },
        { name: 'Aprobar Solicitudes', icon: CheckCircleIcon, action: () => console.log('Aprobar solicitudes'), color: 'green' },
        { name: 'Gestionar Horarios', icon: CalendarIcon, action: () => console.log('Gestionar horarios'), color: 'purple' },
        { name: 'Control de Acceso', icon: ShieldCheckIcon, action: () => console.log('Control acceso'), color: 'red' }
      ]
    },
    {
      id: 'staff',
      ...
      color: 'green',
      actions: [
        { name: 'Asignar Tareas', icon: ClipboardDocumentListIcon, action: () => console.log('Asignar tareas'), color: 'amber' },
        { name: 'Evaluar Desempeño', icon: ChartBarIcon, action: () => console.log('Evaluar desempeño'), color: 'indigo' },
        { name: 'Horarios de Trabajo', icon: ClockIcon, action: () => console.log('Horarios trabajo'), color: 'slate' },
        { name: 'Comunicaciones', icon: MailIcon, action: () => console.log('Comunicaciones'), color: 'blue' }
      ]
    },
    {
      id: 'reports',
      ...
      color: 'purple',
      actions: [
        { name: 'Reportes Diarios', icon: DocumentTextIcon, action: () => console.log('Reportes diarios'), color: 'green' },
        { name: 'Estadísticas', icon: ArrowTrendingUpIcon, action: () => console.log('Estadísticas'), color: 'blue' },
        { name: 'Filtros Avanzados', icon: FunnelIcon, action: () => console.log('Filtros avanzados'), color: 'purple' },
        { name: 'Compartir Reportes', icon: ShareIcon, action: () => console.log('Compartir reportes'), color: 'orange' }
      ]
    },
    {
      id: 'quality',
      ...
      color: 'orange',
      actions: [
        { name: 'Verificar Procesos', icon: ShieldCheckIcon, action: () => console.log('Verificar procesos'), color: 'blue' },
        { name: 'Incidentes', icon: ExclamationTriangleIcon, action: () => console.log('Incidentes'), color: 'red' },
        { name: 'Mejora Continua', icon: ChartPieIcon, action: () => console.log('Mejora continua'), color: 'green' },
        { name: 'Capacitación', icon: UserGroupIcon, action: () => console.log('Capacitación'), color: 'purple' }
      ]
    }
  ]
