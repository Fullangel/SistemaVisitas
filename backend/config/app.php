...
return [
    ...
    */
    ...
    | data for your database seeds. You may change this to any of the
    | locales which will be supported by the Faker library.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The providers listed here will be automatically loaded on the
